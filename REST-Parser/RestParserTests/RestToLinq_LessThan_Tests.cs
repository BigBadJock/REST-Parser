...
namespace RestParserTests
{
    ...
    public class RestToLinq_LessThan_Tests
    {
        ...
        public void LT_Int()
        {
            ...
            // act
            List<Expression<Func<TestItem, bool>>> expressions = parser.Parse("amount[lt]=5");
        ...
        public void LT_Double()
        {
            ...
            // act
            List<Expression<Func<TestItem, bool>>> expressions = parser.Parse("price[lt]=5.25");
        ...
        public void LT_Decimal()
        {
            ...
            // act
            List<Expression<Func<TestItem, bool>>> expressions = parser.Parse("rate[lt]=2.2");
        ...
        public void LT_Date()
        {
            ...
            // act
            List<Expression<Func<TestItem, bool>>> expressions = parser.Parse("birthday[lt]=1968-01-01");
