...
{
    [TestClass]
    public class RestToLinq_LessThan_Tests
    {
        ...
        public void LT_Int()
        {
            ...
            // act
            List<Expression<Func<TestItem, bool>>> expressions = parser.Parse("amount[lt]=5").Expressions;
        ...
        public void LT_Double()
        {
            ...
            // act
            List<Expression<Func<TestItem, bool>>> expressions = parser.Parse("price[lt]=5.25").Expressions;
        ...
        public void LT_Decimal()
        {
            ...
            // act
            List<Expression<Func<TestItem, bool>>> expressions = parser.Parse("rate[lt]=2.2").Expressions;
        ...
        public void LT_Date()
        {
            ...
            // act
            List<Expression<Func<TestItem, bool>>> expressions = parser.Parse("birthday[lt]=1968-01-01").Expressions;
        ...
        public void LT_String()
        {
            try
            {
                List<Expression<Func<TestItem, bool>>> expressions = parser.Parse("surname[lt]=bob").Expressions;
        ...
        public void LT_Boolean()
        {
            try
            {
                List<Expression<Func<TestItem, bool>>> expressions = parser.Parse("flag[lt]=true").Expressions;
                Assert.Fail("Expected REST_InvalidOperatorException not thrown");
            }
            catch (Exception ex)
            {
